    ...
    <>
      <footer className="footer mt-auto p-10 bg-base-200 text-base-content">
        <div>
          ...
          <a className="link link-hover">Popular Shows</a>
        ...
        <div>
          ...
          <a className="link link-hover">Popular Movies</a>
          <a className="link link-hover">New Releases</a>
          <a className="link link-hover">Genres</a>
          <a className="link link-hover">Top Rated</a>
        </div>
        <div>
          <span className="footer-title">Genres</span>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>
            ...
            <br />
            @2023 TheMoviesTM. All right reserved.
          </p>
        </div>
